...
export const Index = ()=>{
    ...
    const fetchAllProducts = async ()=>{
        const response = await axios.get('http://localhost:8000/product/all_products/')
...
<div className="my-8">
    <h2 className="text-center font-bold text-4xl font-serif">New Arrivals</h2>
</div>
